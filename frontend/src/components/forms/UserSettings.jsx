...
export default function UserSettings() {
  ...
  const [settings, setSettings] = useState({
    ...
    biovisibility: preferences.biovisibility,
  ...
  const fetchPreferences = async () => {
    try {
      const res = await axios.get(
        `http:localhost:3000/preferences/${user.username}`
      );
        ...
        <div>
          ...
          <div>
            ...
            <select
              ...
              value={settings.picturevisibility}
              onChange={handleChange}
            >
              <option value="public">Public</option>
          ...
          <div>
            ...
            <select
              id="birthdate-visibility"
              value={settings.birthdatevisibility}
              onChange={handleChange}
            >
              <option value="public">Public</option>
              <option value="private">Friends</option>
          ...
          <div>
            ...
            <div>
              ...
              <select
                id="pasttrips-visibility"
                value={settings.pasttripsvisibility}
                onChange={handleChange}
              >
                <option value="public">Public</option>
                <option value="private">Friends</option>
